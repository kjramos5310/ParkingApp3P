...
async function bootstrap() {
  ...
  const config = new DocumentBuilder()
    .setTitle('MS-Tickets - Sistema de Parqueaderos SaaS')
    .setDescription(
      'Control de entrada, salida y cobro de vehiculos. Todas las operaciones ' +
    ...
    .addTag('tickets', 'Ciclo de vida de los tickets de parqueo')
    .addTag('sse', 'Stream de eventos de tickets en tiempo real')
    .build();
