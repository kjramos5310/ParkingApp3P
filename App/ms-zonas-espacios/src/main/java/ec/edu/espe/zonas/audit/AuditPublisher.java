...
/**
 * Publica eventos de dominio de zonas y espacios a RabbitMQ. Captura
 * automaticamente el usuario autenticado, la IP y la MAC del solicitante.
 *
 * Replica el comportamiento del publicador de ms-usuarios:
...
public class AuditPublisher {
    ...
    public AuditPublisher(RabbitTemplate auditRabbitTemplate,
                          ...
                          @Value("${app.audit.servicio:ms-zonas}") String servicio) {
     ...
     * @param entidad tabla afectada (solo minusculas/guion bajo, 4-15 chars). Ej: "espacios"
     * @param datos   detalle del cambio (id, nombre, estado, etc.)
     */
     ...
     * espera un entero. Igual que ms-usuarios, usamos 1 por defecto.
     */
    ...
    private String resolveIp(HttpServletRequest request) {
        ...
        // Request local (loopback / IPv6) -> usar la IP publica cacheada
     ...
     * no virtual, con direccion fisica valida).
     */
